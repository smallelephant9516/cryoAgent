    ...
    def create_motion_correction_tool(agent) -> Tool:
        ...
        return Tool(
            ...
            description="Perform motion correction using relion_run_motioncorr with MotionCor2. "
                       ...
                       "Optional parameters: gain_ref_path, first_frame_sum, last_frame_sum, use_own, num_threads, bin_factor, bfactor, dose_per_frame, preexposure, patch_x, patch_y, eer_grouping, gain_rot, gain_flip, dose_weighting, grouping_for_ps, wait_for_completion, timeout.",
